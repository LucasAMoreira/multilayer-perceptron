...
public class MultilayerPerceptron {
	...
	public MultilayerPerceptron(int i,int j, int k, int epocas, double alfa){
		this.pesos1 = new double[j][i];
		this.pesos2 = new double[k][j];
		this.entradas = new double[i];
		this.camadaEscondida = new double[j];
		this.saidas = new double[k];
		this.bias1=new double[j];
		this.bias2=new double[k];
		this.alfa=alfa;
		this.epocas = epocas;
	}
